...
[MotrpacRatTraining6moData vignette](https://motrpac.github.io/MotrpacRatTraining6moData/).
...
this dependency, follow [these instructions](https://github.com/MoTrPAC/MotrpacRatTraining6moData#installation) to install 
[MotrpacRatTraining6moData](https://github.com/MoTrPAC/MotrpacRatTraining6moData)
...
let's also load the [MotrpacRatTraining6moData](https://github.com/MoTrPAC/MotrpacRatTraining6moData) 
package. 
```{r}
...
**Note:** Data objects from the [MotrpacRatTraining6moData](https://github.com/MoTrPAC/MotrpacRatTraining6moData) 
...
If the [MotrpacRatTraining6moData](https://github.com/MoTrPAC/MotrpacRatTraining6moData) library
is loaded, you can learn more about any of these data objects with `?`, e.g., `?TISSUE_COLORS`,
...
enrichment was performed for the preprint (TODO: link), namely the 2 largest nodes, 
...
```{r tree plot, fig.width = 10, fig.height = 6, warning=FALSE}
...
preprint (TODO: link) are provided in `GRAPH_PW_ENRICH`. 
...
Rendering `visNetwork` outputs within a loop has some known challenges. See solutions [here](https://stackoverflow.com/questions/47577894/r-markdown-visnetwork-not-displayed-in-html-output-when-using-for-loops-or-fun/). 
